...
static const char *fonts[]          = { "JetBrains Mono NL:style=Bold:size=12", "Font Awesome 6 Brands Regular:style=Bold:size=14" };
static const char dmenufont[]       = "JetBrains Mono NL:style=Bold:size=12";
...
static const char *voldown[] = {"wpctl", "set-volume",  "45", "0.05-", NULL};
static const char *volup[] = {"wpctl", "set-volume",  "45", "0.05+", NULL};
static const char *togglemute[] = {"wpctl", "set-mute", "45", "toggle", NULL};
